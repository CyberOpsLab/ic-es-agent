...
VER="9.1.4"
PKG="elastic-agent-${VER}-darwin-x86_64"
TARBALL="${PKG}.tar.gz"
BASE_DIR="${HOME}/${PKG}"
CA_URL="https://raw.githubusercontent.com/CyberOpsLab/ic-es-agent/main/neo.crt"
CA_PATH="${BASE_DIR}/neo.crt"
...
# (Optional) remove quarantine flag to avoid Gatekeeper prompts
...
sudo ./elastic-agent install \
  ...
  --certificate-authorities="$(pwd)/neo.crt"
