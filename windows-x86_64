...
$installResult = Start-Process -FilePath ".\elastic-agent.exe" -ArgumentList "install --url=$fleeturl --enrollment-token=$enrollment-token --certificate-authorities=$certPath" -Wait -PassThru
